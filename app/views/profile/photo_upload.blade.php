          ...
          <div class="row padding-5">
           <div class="container">
            <div class="btn-group pull-left margin-25-0">
                ...
                <span class="btn btn-danger-reverse"><i class="fa fa-plus-square"></i> Add Profile Picture <i class="fa fa-camera"></i></span>
            </div>
           </div>
          </div>
         </div>
						...
						<div class="panel-body" style="min-height:400px;">	 
						 <div id="uploader" class="row">
						  ...
						  <div class="panel-footer">
							...
							<button class="js-send btn-small btn btn-primary" type="submit">Upload</button>
							</div>
